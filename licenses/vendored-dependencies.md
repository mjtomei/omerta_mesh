...
| [BoringSSL](https://boringssl.googlesource.com/boringssl/) | [Apache-2.0](https://boringssl.googlesource.com/boringssl/+/refs/heads/master/LICENSE) | [boringssl.googlesource.com](https://boringssl.googlesource.com/boringssl/), vendored via [swift-crypto](https://github.com/apple/swift-crypto) | `Sources/CBoringSSL/` |
...
`CBoringSSL` module for direct C API access (used by `DirectCrypto` on macOS and by benchmarks).
